...
export function CreateTeamFragment() {
    ...
    return (
        <div class="fragment">
            ...
            <p class="fragment__field">Название комнаты: <DefaultInput value={title} onChange={setTitle}/></p>
            <p class="fragment__field">Описание комнаты: <DefaultInput value={description} onChange={setDescription}/></p>
            ...
            <div class="fragment__btns">
                <DefaultButton title={"Создать комнату"} type={defaultButtonTypes.ACCEPT} onClick={onClickCreateTableBtn}/>
                <DefaultButton title={"Назад"} type={defaultButtonTypes.DENY} onClick={onClickBackBtn}/>
            </div>
        </div>
    )
}